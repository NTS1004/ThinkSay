<template>
	<view>
		<view class="tab-box" :style="{ height: `${infoBoxHeight}rpx` }">
			...
			<view class="iconBox"><view class="iconfont icon-jiahao uIcon" style="font-size: 38rpx;" @tap="goSignUp"></view></view>
			<view class="title">login</view>
		</view>
		<view class="form-box">
			<input class="form-input" v-model="formData.account" placeholder="账号/昵称" placeholder-class="form-input-placeholder" />
			<input type="password" class="form-input" v-model="formData.password" placeholder="密码" placeholder-class="form-input-placeholder" />
...
export default {
	...
	methods: {
		...
		createView() {
			...
			view.drawRect({ color: '#434343', borderWidth: '2px', radius: '8px' }, { top: '0px', left: '0px', width: '100%', height: '100%' })
			view.show()
