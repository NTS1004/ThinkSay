<template>
	<view>
		...
		<view class="form-box">
			<input class="form-input" v-model="formData.account" placeholder="账号" placeholder-class="form-input-placeholder" />
			<input class="form-input" type="password" v-model="formData.password" placeholder="密码" placeholder-class="form-input-placeholder" />
