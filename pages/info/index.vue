	...
	<view class="content">
		...
		<view v-else>
			...
			<view class="btn-box" v-if="info_type === 'make_friend'">
				<u-button type="primary" class="btn" :custom-style="{ ...ctrlBtn, marginRight: '15rpx' }" @tap="putFriendApply">添加好友</u-button>
				<u-button type="default" :custom-style="{ ...ctrlBtn, marginLeft: '15rpx' }" @tap="goBack">取消</u-button>
			</view>
			<view class="btn-box" v-else>
				<u-button type="primary" :custom-style="{ ...ctrlBtn, marginRight: '15rpx' }" @tap="putFriendAccept">接受</u-button>
...
import { funcDeleteFriend, funcPutFriendApply, funcPutFriendAccept, funcPutFriendSetShield } from '@/api/friend/index.js'
