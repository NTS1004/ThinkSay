<template>
	<view class="search">
		...
		<view class="header">
			...
			<u-input :custom-style="customStyle" :border="true" :clearable="false" placeholder="请输入账号/昵称" @input="inputSearch"></u-input>
		</view>
		<scroll-view class="scroll" scroll-y="true">
			<FriendGroup v-show="this.newFriend.length > 0" groupKey="新朋友" :data="this.newFriend" @Tap="toNewFriendInfo"></FriendGroup>
			<FriendGroup v-show="this.friend.length > 0" groupKey="好友" :data="this.friend" @Tap="toFriendChat"></FriendGroup>
