<template>
	<view class="newFriends">
		...
		<u-input v-model="searchValue" :custom-style="customStyle" :border="true" :clearable="false" placeholder="请输入账号/昵称" @input="inputSearch"></u-input>
		<FriendGroup v-for="(value, key) in searchValue ? filter_new_friends_record : new_friends_record" :key="key" :groupKey="key" :data="value" type="recrod" @Tap="toNewFriend"></FriendGroup>
	</view>
</template>
