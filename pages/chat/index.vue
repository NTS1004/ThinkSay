<template>
	<view class="chat">
		...
		<view class="body">
			<scroll-view class="scroll" :scroll-y="true" :style="{ height: `${scroll_height}px` }" :scroll-into-view="scroll_into_id" @scrolltoupper="scrollToUpper">
		...
		<view class="footer" :style="{ bottom: `${keyboard_height}px` }">
			<scroll-view class="textarea-scroll" :scroll-y="true" :scroll-with-animation="true" :scroll-into-view="text_scroll_into_id">
				<u-input
					v-model="params.msg"
					class="input"
					type="textarea"
